...
urlpatterns = [
    ...
    path('edit_account/', views.edit_account_endpoint, name='edit_account_endpoint'),
    path('edit_cost/', views.edit_cost_endpoint, name='edit_cost_endpoint'),
    path('edit_trip/', views.edit_trip_endpoint, name='edit_trip_endpoint'),
